...
function Home(){
    ...
    return(
        <Container>
            <Box sx={{height:"100vh"}} id="Main">
                <Box sx={{textAlign:'center',py:4}}>
                    <img src={drive} alt="" height="50px"/>
                    <img src={google} alt="" height="50px"/>
                    <h1>Google Drive Download Link Generator</h1>
                    <h4>Paste public sharable URL of your document here to generate the download link</h4>
                </Box>
                <Grid container justifyContent='center' spacing={2}>
                    ...
                    <Grid item md={1}>
                        {!downLink&&<Button variant="contained" type="submit" size="large" sx={{height:"100%"}} onClick={generate}>Generate</Button>}
                        {downLink&&<Button variant="contained" color="error" type="submit" size="large" sx={{height:"100%"}} onClick={reset}>Reset</Button>}
                    </Grid>
                </Grid>
